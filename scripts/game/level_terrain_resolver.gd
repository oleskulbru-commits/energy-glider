...
static func _atomic_mods(atomic_id: String) -> Dictionary:
	var table := {
		...
		"tight_chop": {"frequency_scale": 1.35, "amplitude_scale": 0.95},
		...
		"razor_spine": {"crest_sharpness_scale": 1.15, "ridge_power_add": 0.18, "z_scale": 0.85},
		"broken_teeth": {"crest_sharpness_scale": 1.1, "frequency_scale": 1.1, "z_scale": 1.15},
		"soft_bowls": {"amplitude_scale": 0.95, "flat_bias_add": 0.04, "z_scale": 1.05},
		"deep_basins": {"amplitude_scale": 1.12, "flat_bias_add": -0.02, "z_scale": 1.1},
		"escape_gulches": {"z_scale": 1.2, "frequency_scale": 1.05},
		...
		"wall_faces": {"amplitude_scale": 1.15, "frequency_scale": 1.1, "ridge_power_add": 0.1},
		...
		"slalom_spines": {"z_scale": 1.22, "frequency_scale": 1.05},
		"maze_basins": {"z_scale": 1.3, "warp_scale": 1.1},
		"honest_terrain": {"warp_scale": 0.55},
		"soft_warp": {"warp_scale": 0.85},
		"twisted_warp": {"warp_scale": 1.3},
		...
		"momentum_tax": {"frequency_scale": 1.1, "flat_bias_add": -0.04, "amplitude_scale": 1.05},
		"ridge_gauntlet": {"crest_sharpness_scale": 1.12, "frequency_scale": 1.15, "flat_bias_add": -0.06},
		"blind_backsides": {"crest_sharpness_scale": 1.08, "ridge_power_add": 0.08},
		"cliffette_drops": {"amplitude_scale": 1.12, "ridge_power_add": 0.12},
		"no_line_chaos": {"z_scale": 1.28, "warp_scale": 1.15, "frequency_scale": 1.1},
		"syncopated_ridges": {"frequency_scale": 1.12, "crest_sharpness_scale": 1.08},
	}
...
static func _apply_modifiers(base: Dictionary, mods: Dictionary) -> Dictionary:
	return {
		...
		"warp_strength": maxf(base.warp_strength * mods.warp_scale, 8.0),
		"ridge_power": clampf(base.ridge_power + mods.ridge_power_add, 1.2, 2.6),
		"frequency_scale": clampf(base.frequency_scale * mods.frequency_scale, 0.45, 1.8),
		"z_scale": clampf(base.z_scale * mods.z_scale, 0.45, 1.8),
		"flat_bias": clampf(base.flat_bias + mods.flat_bias_add, -0.25, 0.25),
		"crest_sharpness": clampf(base.crest_sharpness * mods.crest_sharpness_scale, 0.75, 1.35),
	}
